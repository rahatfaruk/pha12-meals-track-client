      ...
      <div className="max-w-md mx-auto p-6 border rounded-md shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <label className="block mb-4">
            ...
            <input type="email" {...register('email', {required:true})} className="border w-full min-w-0 px-3 py-2 rounded-md bg-gray-50 dark:text-gray-700" placeholder="example@mail.com" />
          ...
          <label className="block mb-4 relative">
            ...
            <input type={showPassword ? "text" : "password"} {...register('password', {required:true, pattern: /(?=.*[a-z])(?=.*[A-Z]).{6,}/ })} className="border w-full min-w-0 px-3 py-2 rounded-md bg-gray-50 dark:text-gray-700" />
